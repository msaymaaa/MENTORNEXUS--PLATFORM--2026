        ...
        <div className="space-y-3">
          {filteredNotifications.map((notif) => (
            <div
              ...
              className={`p-4 sm:p-5 rounded-2xl border transition-all cursor-pointer flex items-start justify-between space-x-4 ${
                !notif.read 
            ...
            >
              <div className="flex items-start space-x-3.5">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-[#9E9A90] leading-relaxed max-w-xl">{notif.message}</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 shrink-0">
                ...
                {notif.linkTab && (
                  <ChevronRight className="w-4 h-4 text-[#7A766E]" />
                )}
              </div>
            </div>
          ))}
